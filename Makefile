...
03-gpu-programming-methods: 03-gpu-programming-methods.cu
	$(NVCC) -O3 -arch=$(ARCH) -rdc=true --no-device-link -Xcompiler -Wno-error -o 03-gpu-programming-methods 03-gpu-programming-methods.cu -lcudadevrt
